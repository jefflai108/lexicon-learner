...
dir=/data/sls/temp/clai24/data/speech_matrix/speech_to_unit/mfa_s2u_manifests/dummy/es_dummy
aligned_dir=${dir}-aligned
mkdir -p $aligned_dir
mfa adapt $dir english english $aligned_dir -t ${dir}/.mfa_adapt -j 1 -v --debug --clean --beam 1000 --retry-beam=1500
#mfa adapt $dir spanish_castilian_ipa spanish $aligned_dir -t ${dir}/.mfa_adapt -j 1 -v --debug --clean --beam 1000 --retry-beam=1500
