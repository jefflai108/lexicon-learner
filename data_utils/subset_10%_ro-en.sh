...
S2U_DIR=/data/sls/temp/clai24/data/speech_matrix/speech_to_unit/s2u_manifests/ro-en

L=1024
input_file=${S2U_DIR}/train_mined_t1.07_filter${L}_u2u.tsv
output_file=${S2U_DIR}/train_mined_t1.07_filter${L}_subset0.1_u2u.tsv
