...
if __name__ == '__main__':
    ...
    src_audio_loc = 'es_aud.zip:74:15873'
    ...
    feat = get_features_or_waveform(os.path.join(audio_src_pth, src_audio_loc), need_waveform=False, use_sample_rate=16000)
    print("extract fbank with feat shape", feat.shape)
