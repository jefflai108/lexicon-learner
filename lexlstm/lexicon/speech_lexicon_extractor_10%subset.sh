...
for target_len in 1024; do
    ...
    train_u2u_file=${manifest_root}/train_mined_t${DATA_FILTER_THRESHOLD}_${target}.tsv
    lexicon_alignment_root=/data/sls/temp/clai24/data/speech_matrix/speech_to_unit/lexicon_alignment/${SRC_LAN}-${TGT_LAN}
    train_lex_file=${lexicon_alignment_root}/train_mined_t${DATA_FILTER_THRESHOLD}_${target}.tsv
